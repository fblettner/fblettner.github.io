...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '14px', margin: '24px 0'}}>
  <div style={{border: '1px solid rgba(255,255,255,0.10)', borderRadius: '10px', padding: '14px', background: 'rgba(255,255,255,0.02)'}}>
    ...
    <div style={{fontSize: '12px'}}>En haut de l'en-tête. Liste chaque app que l'appelant peut voir, triée par ordre d'affichage.</div>
  </div>
  <div style={{border: '1px solid rgba(255,255,255,0.10)', borderRadius: '10px', padding: '14px', background: 'rgba(255,255,255,0.02)'}}>
    <div style={{fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.07em', fontWeight: 700, color: '#4a9eff', marginBottom: '6px'}}>CHAMP APP</div>
  ...
  <div style={{border: '1px solid rgba(255,255,255,0.10)', borderRadius: '10px', padding: '14px', background: 'rgba(255,255,255,0.02)'}}>
    <div style={{fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.07em', fontWeight: 700, color: '#4a9eff', marginBottom: '6px'}}>PARAMÈTRES → APPS</div>
  ...
  <div style={{border: '1px solid rgba(255,255,255,0.10)', borderRadius: '10px', padding: '14px', background: 'rgba(255,255,255,0.02)'}}>
    ...
    <div style={{fontSize: '12px'}}><code>{"sql:<app>-*:*"}</code>, <code>{"screen:<app>:*"}</code>, <code>{"menu:<app>:*"}</code> — un rôle par app garde les choses propres.</div>
  </div>
</div>

---

## Comment une app est créée
...
<div style={{border: '1px solid rgba(255,255,255,0.10)', borderRadius: '10px', overflow: 'hidden', margin: '20px 0', background: 'rgba(255,255,255,0.02)', fontSize: '12px'}}>
  <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', borderBottom: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.03)'}}>
    <div style={{fontWeight: 700}}>Paramètres → Apps</div>
    <div style={{display: 'flex', gap: '6px'}}>
      <span style={{padding: '5px 12px', borderRadius: '6px', background: 'rgba(50,215,75,0.10)', border: '1px solid rgba(50,215,75,0.40)', color: '#4ade80', fontSize: '11px', fontWeight: 600}}>↑ Importer une app</span>
      <span style={{padding: '5px 14px', borderRadius: '6px', background: '#4a9eff', color: '#fff', fontSize: '11px', fontWeight: 700}}>+ Nouvelle app</span>
    </div>
  </div>
...
- **⬇ Exporter** — produit un zip de chaque entité qui porte l'identifiant de cette app (voir [Export / import](#export-import)).
...
- **Grouper les connecteurs par app même en partageant un pool.** Un `billing-invoices` + `billing-credits` qui interrogent le même pool `default` est plus clair qu'`invoices` + `credits`.
...
- [Plugins](./plugins.md) — callables Python personnalisés empaquetés avec les apps.
- [i18n](./i18n.md) — ajout de langues et packs de libellés par app.
- [Déploiement → Mise à jour](../deployment/upgrading.md) — déplacer les personnalisations client à travers les mises à jour de framework et d'apps fournisseur.
