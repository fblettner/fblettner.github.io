...
| Vous voulez… | Lisez |
|---|---|
| **Appliquer le même motif à SAP / NetSuite / autre ERP** | Même recette, pointez le pool sur la base ERP. Pour JD Edwards spécifiquement, l'app packagée [Nomajde](https://docs.nomana-it.fr/liberty/nomajde/overview) livre déjà tous les écrans. |
