...
Si l'un de ces points manque, le [guide de démarrage du framework](../framework/getting-started/installation.md) couvre le chemin d'installation et [Authentification → Rôles et permissions](../framework/auth/roles-permissions.md) couvre le câblage des rôles.
