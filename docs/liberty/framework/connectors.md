...
For CI scripts and external orchestrators, the same surface is reachable via REST at `/admin/config/connectors/*` — see [REST API reference](../references/rest-api.md#admin-config).
