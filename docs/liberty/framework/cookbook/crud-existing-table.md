...
- For JD Edwards admin specifically, the packaged [Nomajde](https://docs.nomana-it.fr/nomajde/) app ships every screen you'd build here — pre-built, license-gated.
