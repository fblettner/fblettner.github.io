...
<svg viewBox="0 0 1000 320" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '100%', height: 'auto', margin: '24px 0', display: 'block'}}>
  ...
  <text x="455" y="105" fill="#4ade80" fontSize="9" fontWeight="700" textAnchor="middle" fontFamily="ui-monospace, monospace">success</text>
  <path d="M 440 175 L 470 175 L 470 250 L 490 250" stroke="#f87171" strokeWidth="1.5" fill="none" markerEnd="url(#ie-arrow-red)"/>
  <text x="466" y="215" fill="#f87171" fontSize="9" fontWeight="700" textAnchor="middle" fontFamily="ui-monospace, monospace">failure</text>
