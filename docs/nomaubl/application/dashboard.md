...
<svg viewBox="0 0 1000 160" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '100%', height: 'auto', margin: '24px 0', display: 'block'}}>
  ...
  <text x="125" y="70" fill="#4a9eff" fontSize="13" fontWeight="700" textAnchor="middle" fontFamily="system-ui, sans-serif">📊 Counter card</text>
  <text x="125" y="92" fill="currentColor" fontSize="11" fontStyle="italic" textAnchor="middle" fontFamily="system-ui, sans-serif" opacity="0.85">Approved · 982</text>
  ...
  <text x="615" y="70" fill="currentColor" fontSize="13" fontWeight="700" textAnchor="middle" fontFamily="system-ui, sans-serif">✅ Date range</text>
  <text x="615" y="92" fill="currentColor" fontSize="11" fontStyle="italic" textAnchor="middle" fontFamily="system-ui, sans-serif" opacity="0.78">+ Status = Approved</text>
  <rect x="755" y="40" width="225" height="80" rx="12" fill="url(#dash-ct-g-blue)" stroke="#4a9eff" strokeWidth="2"/>
  <text x="867" y="70" fill="#4a9eff" fontSize="13" fontWeight="700" textAnchor="middle" fontFamily="system-ui, sans-serif">📋 Filtered list</text>
  <text x="867" y="92" fill="currentColor" fontSize="11" fontStyle="italic" textAnchor="middle" fontFamily="system-ui, sans-serif" opacity="0.85">982 matching rows</text>
  <line x1="230" y1="80" x2="265" y2="80" stroke="#4a9eff" strokeWidth="1.5" markerEnd="url(#dash-ct-arrow)"/>
  <text x="247" y="73" fontSize="9" fill="#4a9eff" textAnchor="middle" fontFamily="ui-monospace, monospace" fontWeight="700">click</text>
