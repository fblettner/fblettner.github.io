...
const sidebars: SidebarsConfig = {
  ...
  nomaublSidebar: [
    'nomaubl/getting-started',
    {
      type: 'category',
      label: 'Application',
      link: {type: 'generated-index', slug: '/nomaubl/application', description: 'Main app navigation: dashboard, invoices, e-reporting, e-directory and integration errors.'},
      items: [
    ...
    },
    {
      type: 'category',
      label: 'Management',
      link: {type: 'generated-index', slug: '/nomaubl/management', description: 'Operational management: file versions and lifecycle history.'},
      items: [
